...
import { ANIMATION_TYPES, GRADIENT_TYPES, MODULE_TYPES, moduleList, QUESTION_TYPES, MESSAGES, } from "./types/enums.js";
...
export const welcome = async () => {
    ...
    const welcomeTextGradient = gradientText(welcomeTextFiglet, GRADIENT_TYPES.RAINBOW);
...
const selectModule = async () => {
    const selectedModule = await askQuestion(MESSAGES.MODULE_SELECTION, QUESTION_TYPES.LIST, moduleList);
...
//# sourceMappingURL=appFunctions.js.map